...
class ComponentHeaderModel: NSObject, CommonHeaderModel {
    ...
    static var headerKind: CommonTableView.Header.Type = ComponentHeader.self
    var customConfiguration: ((CommonTableView.Header) -> Void)?
    var title: String
    
    init(identifier: String = UUID().uuidString,
         customConfigurartion: ((CommonTableView.Header) -> Void)? = nil,
         title: String) {
...
class ComponentHeader: CommonTableView.Header {
...
class ComponentCellModel: NSObject, CommonCellModel {
    var identifier: String = UUID().uuidString
    static var cellKind: CommonTableView.Cell.Type = ComponentCell.self
    var selectable: Bool = true
    var customConfiguration: ((CommonTableView.Cell) -> Void)?
...
class ComponentCell: CommonTableView.Cell {
